        ...
        GroupBox {
            ...
            Column {
                ...
                Label {
                    width: parent.width
                    id: resFPSdesc
                    text: qsTr("Setting these too high for your PC or connection may result in lag, stutter, or errors.")
                    font.pointSize: 9
                    wrapMode: Text.Wrap
                }
                ...
                Row {
                    ...
                    AutoResizingComboBox {
                        ...
                        Component.onCompleted: {
                            ...
                            for (var displayIndex = 0; !done; displayIndex++) {
                                ...
                                addDetectedResolution(qsTr("Native (safe area)"), safeAreaRect)
                            }
                            ...
                            if (!index_set) {
                                ...
                                resolutionListModel.append({
                                                               "text": qsTr("Tùy chỉnh")+" ("+StreamingPreferences.width+"x"+StreamingPreferences.height+")",
                        ...
                        NavigableDialog {
                            ...
                            ColumnLayout {
                                Label {
                                    text: qsTr("Tùy chỉnh các độ phân giải không được hỗ trợ chính thức bởi GeForce Experience, vì vậy nó sẽ không đặt Độ phân giải màn hình của máy chủ . Bạn sẽ cần đặt nó theo cách thủ công trong lúc chơi.") + "\n\n" +
                                          qsTr("Các độ phân giải không được hỗ trợ bởi khách đặc biệt hoặc PC trỡ của bạn có thể gây ra lỗi truyền." ) + "\n"
                                    wrapMode: Label.WordWrap
                                    Layout.maximumWidth: 300
                                }

                                Label {
                                    text: qsTr("Nhập độ phân giải tùy chỉnh:")
                                    font.bold: true
                                }
                    ...
                    AutoResizingComboBox {
                        ...
                        NavigableDialog {
                            ...
                            onAccepted: {
                                ...
                                for (var i = 0; i < fpsListModel.count; i++) {
                                    if (fpsListModel.get(i).is_custom) {
                                        ...
                                        fpsListModel.setProperty(i, "text", qsTr("Tùy chỉnh (%1 FPS)").arg(fps))
                            ...
                            ColumnLayout {
                                Label {
                                    text: qsTr("Nhập tốc độ hình ảnh tùy chỉnh:")
                                    font.bold: true
                                }
                        ...
                        function reinitialize() {
                            ...
                            if (!found) {
                                currentIndex = addRefreshRateOrdered(model, saved_fps, qsTr("Tùy chỉnh (%1 FPS)").arg(saved_fps), true)
                            }
                            else {
                                addRefreshRateOrdered(model, "", qsTr("Tùy chỉnh"), true)
                            }
                ...
                Label {
                    width: parent.width
                    id: bitrateDesc
                    text: qsTr("Lower bitrate on slower connections. Increase bitrate to improve image quality.")
                    font.pointSize: 9
                    wrapMode: Text.Wrap
                }
        ...
        GroupBox {
            ...
            Column {
                ...
                CheckBox {
                    ...
                    width: parent.width
                    text: qsTr("Swap A/B and X/Y buttons on gamepad")
                    font.pointSize: 12
                    ...
                    ToolTip.timeout: 5000
                    ToolTip.visible: hovered
                    ToolTip.text: qsTr("Swap the A/B and X/Y button positions to match the Nintendo button layout")
                }

                CheckBox {
                    id: singleControllerCheck
                    width: parent.width
                    text: qsTr("Force gamepad #1 to be always connected")
                    font.pointSize:  12
                    ...
                    ToolTip.timeout: 5000
                    ToolTip.visible: hovered
                    ToolTip.text: qsTr("Forces a gamepad to always be connected to the host, even if no gamepads are actually connected to this PC.") + " " +
                                  qsTr("Only enable this option when streaming a game that does not support gamepad hot-plugging.")
                }
                ...
                CheckBox {
                    ...
                    hoverEnabled: true
                    width: parent.width
                    text: qsTr("Enable mouse control with gamepad by holding Start")
                    font.pointSize: 12
        ...
        GroupBox {
            ...
            Column {
                ...
                CheckBox {
                    id: enableYUV444
                    width: parent.width
                    text: qsTr("Bật YUV 4:4:4 (Thử nghiệm)")
                    font.pointSize: 12
