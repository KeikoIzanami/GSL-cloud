...
ApplicationWindow {
    ...
    header: ToolBar {
        ...
        RowLayout {
            ...
            NavigableToolButton {
                ...
                onClicked: Qt.openUrlExternally("https://discord.gg/JchSpVWEwg");
            ...
            NavigableToolButton {
                property string browserUrl: "https://github.com/KeikoIzanami/GSL-cloud/releases/"
                ...
                {
                    ToolTip.text = qsTr("Update available for GSL: Version %1").arg(version)
            ...
            NavigableToolButton {
                ...
                ToolTip.timeout: 3000
                ToolTip.visible: hovered
                ToolTip.text: qsTr("Cộng đồng giúp đỡ") + (helpShortcut.nativeText ? (" ("+helpShortcut.nativeText+")") : "")
    ...
    NavigableMessageDialog {
        ...
        onAccepted: {
            Qt.openUrlExternally("https://github.com/KeikoIzanami/GSL-cloud/releases/");
        }
    }
