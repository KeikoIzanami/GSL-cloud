...
int main(int argc, char *argv[])
{
    ...
    app.setDesktopFileName("com.gslcloud.GSLCloud");
    qputenv("SDL_VIDEO_WAYLAND_WMCLASS", "com.gslcloud.GSLCloud");
    qputenv("SDL_VIDEO_X11_WMCLASS", "com.gslcloud.GSLCloud");
